...
export default function VideoNodeInspector({ nodeId, data }) {
  ...
  return (
    <div className={styles.inspectorContent}>
      ...
      {/* 基本设置 */}
      <div className={styles.section}>
        <div className={styles.sectionHeader} onClick={() => toggleSection('basicSettings')}>
      ...
      {/* 播放设置 */}
      <div className={styles.section}>
        <div className={styles.sectionHeader} onClick={() => toggleSection('playSettings')}>
          ...
          <button 
            ...
            onClick={(e) => {
              e.stopPropagation();
              toggleSection('playSettings');
            }}
          >
            {expandedSections.playSettings ? '▼' : '▶'}
          </button>
        </div>
        {expandedSections.playSettings && (
          <>
      ...
      {/* 字幕编辑器 */}
      <div className={styles.section}>
        <div className={styles.sectionHeader} onClick={() => toggleSection('subtitles')}>
      ...
      {/* 随机时间事件 */}
      <div className={styles.section}>
        <div className={styles.sectionHeader} onClick={() => toggleSection('randomTimeEvent')}>
          ...
          <button 
            ...
            onClick={(e) => {
              e.stopPropagation();
              toggleSection('randomTimeEvent');
            }}
          >
            {expandedSections.randomTimeEvent ? '▼' : '▶'}
          </button>
        </div>
        {expandedSections.randomTimeEvent && (
          <>
      ...
      {/* 变量条设置 */}
      <div className={styles.section}>
        <div className={styles.sectionHeader} onClick={() => toggleSection('variableBar')}>
          ...
          <button 
            ...
            onClick={(e) => {
              e.stopPropagation();
              toggleSection('variableBar');
            }}
          >
            {expandedSections.variableBar ? '▼' : '▶'}
          </button>
        </div>
        {expandedSections.variableBar && (
          <>
      ...
      {/* 数据统计设置 */}
      <div className={styles.section}>
        <div className={styles.sectionHeader} onClick={() => toggleSection('stats')}>
      ...
      {/* 跳转点设置 */}
      <div className={styles.section}>
        <div className={styles.sectionHeader} onClick={() => toggleSection('jumpPoint')}>
          ...
          <button 
            ...
            onClick={(e) => {
              e.stopPropagation();
              toggleSection('jumpPoint');
            }}
          >
            {expandedSections.jumpPoint ? '▼' : '▶'}
          </button>
        </div>
        {expandedSections.jumpPoint && (
          <>
      ...
      {/* 带货设置 */}
      <div className={styles.section}>
        <div className={styles.sectionHeader} onClick={() => toggleSection('commerce')}>
